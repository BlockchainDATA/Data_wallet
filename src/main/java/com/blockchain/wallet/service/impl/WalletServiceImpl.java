...
public class WalletServiceImpl implements IWalletService {
    ...
    public String createAddr() {
        AddressEntity addressEntity = web3jUtil.createAddr(UrlConstUtil.ETH_NODE_LIST.get(RandomUtil.getRandomInt(UrlConstUtil.ETH_NODE_LIST.size())));
    ...
    public String privateKeyTransfer(String fromAddress, String toAddress, String privateKey, String value) {
        BigInteger nonce = web3jUtil.getNonce(fromAddress, UrlConstUtil.ETH_NODE_LIST.get(RandomUtil.getRandomInt(UrlConstUtil.ETH_NODE_LIST.size())));
        //获取交易签名
        ...
        String txHash = web3jUtil.getTxHash(txSign, UrlConstUtil.ETH_NODE_LIST.get(RandomUtil.getRandomInt(UrlConstUtil.ETH_NODE_LIST.size())));
